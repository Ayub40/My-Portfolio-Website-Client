...
//     return (
//         <div className="hero rounded-lg lg:h-[560px] lg:w-[1280px] relative m-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl mt-24">
//             <div className="hero-content flex-col lg:flex-row-reverse lg:gap-32 space-y-6">
//                 <Image src="/Ayub Khan.jpg" alt="Ayub Khan" width={400} height={400} priority />
//                 <div className="text-white">
//                     <h1 className="text-5xl font-bold">Hi 👋, <br /></h1>
//                     <h1 className="text-5xl font-bold">
//                         I’m <span>Ayub Khan</span> <br />
//                         <span className="text-[#22C55E]">Front-end</span> Developer
//                     </h1>
//                     <p className="py-6 text-[#9CA3AF] text-lg font-semibold">
//                         I am a passionate and dedicated Web Developer with a solid foundation
//                         in modern web technologies. I am committed to continuous learning
//                         and delivering high-quality solutions that enhance user experience.
//                     </p>
